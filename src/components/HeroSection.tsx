...
const floatingElements = [
  { icon: Plane, delay: 0, x: "10%", y: "20%", rotation: -15 },
  { icon: MapPin, delay: 0.2, x: "85%", y: "15%", rotation: 10 },
  { icon: Palmtree, delay: 0.4, x: "5%", y: "70%", rotation: -5 },
  { icon: Ship, delay: 0.6, x: "90%", y: "65%", rotation: 15 },
  { icon: Sparkles, delay: 0.8, x: "75%", y: "40%", rotation: 0 },
];
    ...
    <section className="relative min-h-screen bg-gradient-hero overflow-hidden pt-20">
      ...
      {floatingElements.map((element, index) => (
        <motion.div
          ...
          transition={{ delay: element.delay, duration: 0.5, type: "spring" }}
        >
          <motion.div
            animate={{
              y: [0, -20, 0],
      ...
      <div className="container mx-auto px-4 py-20 flex flex-col items-center justify-center min-h-[80vh] text-center relative z-10">
        ...
        >
          ...
          {[0, 1, 2].map((i) => (
            ...
            >
              <div
                className="w-8 h-8 bg-accent rounded-full shadow-playful flex items-center justify-center"
                style={{ transform: `translate(${120 + i * 20}px, -50%)` }}
              >
